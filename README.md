...
A Claude Code plugin that generates a **Pre-Sales → PS Knowledge Transfer Google Doc** for any account by gathering live data from Glean (Salesforce + Gong), Granola, and Slack.
...
| Chat platform, volumes, handoff setup | Gong transcripts + Granola |
| Email system, routing, webform | Gong transcripts + Granola |
| Telephony provider, CCaaS, IVR | Gong transcripts + Granola |
| Primary & Secondary Use Cases | Glean + Gong |
| Risks & Objections | Gong transcripts |
| Next Steps | Gong + Granola |
